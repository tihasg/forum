package br.tihasg.com.foru.exception

import br.tihasg.com.foru.dto.ErrorView
...
class ExceptionHandler {
    ...
    fun handleValidationError(exception: MethodArgumentNotValidException, request: HttpServletRequest): ErrorView {
        ...
        return ErrorView(status = HttpStatus.INTERNAL_SERVER_ERROR.value(), error = HttpStatus.INTERNAL_SERVER_ERROR.name, message = errorMessage.toString(), path = request.servletPath)
    }
